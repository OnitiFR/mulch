...
// endpoints (see ReplicationReceiver). It carries just enough information to
// list replicas, identify their origin, and promote them to local VMs (the
...
type ReplicaState struct {
	...
	DiskSize      uint64
	Config        string // raw VM TOML config (used by promote)
