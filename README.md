...
```sh
go install github.com/OnitiFR/mulch/cmd/mulch@latest (Go 1.16+)
go get -u github.com/OnitiFR/mulch/cmd/mulch (Go 1.15-)
```
...
### Install:
As a user:
 - `go install github.com/OnitiFR/mulch/cmd/...@latest` (Go 1.16 and more)
 - `go get -u github.com/OnitiFR/mulch/cmd/...` (Go 1.15 and less)
